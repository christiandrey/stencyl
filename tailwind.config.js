...
const fontFamily = {
	...
	mono: ['Consolas', 'Liberation Mono', 'Menlo', 'Courier', 'Monaco', 'monospace'],
};
	...
	theme: {
		...
		extend: {
			screens: {
				...
				print: {raw: 'print'},
				retina: {
					raw: 'only screen and (min-device-pixel-ratio: 2), only screen and (min-resolution: 192dpi), only screen and (min-resolution: 2dppx)',
				},
			},
		},
	},
